...
namespace ICT4_Participation_ASP.Models
{
    public class HelpRequest
    {
        ...
        public HelpRequest(int id, string titel, string description, string location, int travelTime, bool urgent,
            TransportationType transportationType, DateTime startDate, DateTime endDate, int volunteersNumbers,
            bool interview, bool completed, List<Skill> skills)
        {
            ID = id;
            Titel = titel;
