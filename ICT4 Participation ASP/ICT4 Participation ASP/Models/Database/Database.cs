    ...
    public class Database : Repository
    {
        ...
        public Account Login(string username, string password)
        {
            try
            {
                ...
                //Voer de query uit
                DataTable dt = OracleManager.ExecuteReadQuery(DatabaseQuerys.Query["GetUserLogin"],
                    loginParameter);
        ...
        public Admin Login(string username, string password, string barcode)
        {
            ...
            //Voer de query uit
            DataTable dt = OracleManager.ExecuteReadQuery(DatabaseQuerys.Query["GetAdminLogin"], parameters);
        ...
        public Needy LoginWithBarcode(string Barcode)
        {
            ...
            try
            {
                ...
                //Voer de query uit
                DataTable dt = OracleManager.ExecuteReadQuery(DatabaseQuerys.Query["GetUserLoginByBarcode"],
                    loginParameter);
        ...
        public int GetAccountId(string username)
        {
            ...
            DataTable d = OracleManager.ExecuteReadQuery(DatabaseQuerys.Query["GetAccountID"], idParameter);
        ...
        public bool AddVolunteer(Volunteer volunteer, string password)
        {
            try
            {
                ...
                OracleManager.ExecuteNonQuery(DatabaseQuerys.Query["InsertVolunteer"], volunteerParameter);
                return true;
            }
            catch (Exception)
            {
        ...
        public bool AddNeedy(Needy needy, string password)
        {
            try
            {
                ...
                OracleManager.ExecuteNonQuery(DatabaseQuerys.Query["InsertNeedy"], needyParameter);
                return true;
            }
            catch (Exception)
            {
        ...
        public void InsertAccount(Account account, string password)
        {
            try
            {
                ...
                OracleManager.ExecuteNonQuery(DatabaseQuerys.Query["InsertAccount"], accountParameter);
            }
            catch (Exception)
            {
                throw;
        ...
        public void InsertUser(User user)
        {
            try
            {
                ...
                OracleManager.ExecuteNonQuery(DatabaseQuerys.Query["InsertUser"], userParameter);
            }
            catch (Exception ex)
            {
        ...
        public List<Review> GetAllReviews()
        {
            ...
            DataTable dt = OracleManager.ExecuteReadQuery(DatabaseQuerys.Query["GetAllReviews"], null);
            foreach (DataRow dr in dt.Rows)
            {
                riviews.Add(
                    new Review(
        ...
        public bool UpdateVolunteer(Volunteer volunteer, string password)
        {
            try
            {
                ...
                OracleManager.ExecuteNonQuery(DatabaseQuerys.Query["UpdateUser"], userParameter);
        ...
        public void DeleteHelprequest(int id)
        {
            try
            {
                ...
                OracleManager.ExecuteNonQuery(DatabaseQuerys.Query["DeleteHelpRequest"], deleteParameter);
            }
            catch (Exception)
            {
                throw;
        ...
        public void DeleteReview(int HelpRequestID, int VolunteerID, string message)
        {
            try
            {
                ...
                OracleManager.ExecuteNonQuery(DatabaseQuerys.Query["DeleteReview"], deleteParameter);
            }
            catch (Exception)
            {
                throw;
        ...
        public void AcceptedVolunteer(int ID)
        {
            try
            {
                ...
                OracleManager.ExecuteNonQuery(DatabaseQuerys.Query["AcceptedVolunteer"], updateParameter);
            }
            catch (Exception)
            {
                throw;
        ...
        public void DenyVolunteer(int ID)
        {
            try
            {
                ...
                OracleManager.ExecuteNonQuery(DatabaseQuerys.Query["DenyVolunteer"], deleteParameter);
            }
            catch (Exception)
            {
                throw;
        ...
        public List<int> GetAcceptedHelpRequests(OracleParameter[] parameter)
        {
            ...
            try
            {
                DataTable dt = OracleManager.ExecuteReadQuery(DatabaseQuerys.Query["GetAcceptedHelpRequests"],
                    parameter);
