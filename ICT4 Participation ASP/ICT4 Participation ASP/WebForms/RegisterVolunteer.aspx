...
<asp:Content ID="Content1" ContentPlaceHolderID="Master" runat="server">
    <div class="container col-sm-push-4 col-lg-4">
        ...
        <asp:TextBox type="email" ID="inputEmail" class="form-control" placeholder="Email" required autofocus runat="server"></asp:TextBox>
        <label for="inputName" class="sr-only">Naam</label>
        <asp:TextBox ID="inputName" class="form-control" placeholder="Name" required autofocus runat="server"></asp:TextBox>
        <label for="inputAdres" class="sr-only">Adres</label>
        <asp:TextBox ID="inputAdres" class="form-control" placeholder="Adres" required autofocus runat="server"></asp:TextBox>
        <label for="inputCity" class="sr-only">Woonplaats</label>
        <asp:TextBox ID="inputCity" class="form-control" placeholder="City" required autofocus runat="server"></asp:TextBox>
        <label for="inputPhonenumber" class="sr-only">Telefoon nummer</label>
        <asp:TextBox ID="inputPhonenumber" class="form-control" placeholder="Phonenumber" required autofocus runat="server"></asp:TextBox>
