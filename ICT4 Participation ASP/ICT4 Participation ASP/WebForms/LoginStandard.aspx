...
<asp:Content ID="Content1" ContentPlaceHolderID="Master" runat="server">
    ...
    <div class="container col-sm-push-4 col-lg-4">
        ...
        <asp:RequiredFieldValidator ID="UsernameRequiredFieldValidator" runat="server" display="Dynamic" ControlToValidate="inputUsername" ErrorMessage="Je moet een email adres invullen" ForeColor="Red"></asp:RequiredFieldValidator>
        <asp:TextBox id="inputUsername" class="form-control" placeholder="Email adres" required autofocus runat="server"></asp:TextBox>
